...
<div class="layui-card">
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        ...
        <div class="layui-card-body">
            <form class="layui-form" id="edit_book_form" action="${rc.contextPath}/admin/updateBook.do" method="post">
                <input type="text" hidden  name="id" required lay-verify="required" layui-input-inline value="<#if BookEdit.id??>${BookEdit.id}</#if>">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="lid" lay-verify="required" lay-search="">
                            ...
                            <option
                                <#if BookEdit??>
                                    <#if category.id==BookEdit.bookCategory.id>
                                        selected
                                    </#if>
                                </#if>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="name" required lay-verify="required" placeholder="请输入书籍名"
                       autocomplete="off" class="layui-input" value="<#if BookEdit.name??>${BookEdit.name}</#if>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="author" required lay-verify="required" placeholder="请输入作者"
                       autocomplete="off" class="layui-input" value="<#if BookEdit.author??>${BookEdit.author}</#if>">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="press" required lay-verify="required" placeholder="请输入作者"
                       autocomplete="off" class="layui-input" value="<#if BookEdit.press??>${BookEdit.press}</#if>">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width: 100px;">
                <input type="number" name="bookPrice" placeholder="￥" lay-verify="price" required
                       lay-verify="required" class="layui-input" value="<#if BookEdit.price??>${(BookEdit.price/100)?c}</#if>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="bookPublishDate" placeholder="请选择出版时间" required lay-verify="required" class="layui-input" id="publication_time" value="<#if BookEdit.publishDate??>${BookEdit.publishDate?string("yyyy-MM-dd")}</#if> ">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" name="stock" placeholder="" lay-verify="stock" required
                       lay-verify="required" autocomplete="off" class="layui-input" value="<#if BookEdit.stock??>${BookEdit.stock?c}</#if>">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" name="pageNum" lay-verify="stock" required lay-verify="required"
                       placeholder="请输入页数" autocomplete="off" class="layui-input" value="<#if BookEdit.pageNum??>${BookEdit.pageNum?c}</#if>">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" name="wordsNum" lay-verify="stock" required lay-verify="required"
                       placeholder="请输入字数" autocomplete="off" class="layui-input" value="<#if BookEdit.wordsNum??>${BookEdit.wordsNum?c}</#if>">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="paper" required lay-verify="required" placeholder="请输入纸张类型"
                       autocomplete="off" class="layui-input" value="<#if BookEdit.paper??>${BookEdit.paper}</#if>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">书籍描述:</label>
            <div class="layui-input-inline">
                <input type="text" name="desc" required lay-verify="required" placeholder="请输入书籍描述"
                       autocomplete="off" class="layui-input" value="<#if BookEdit.desc??>${BookEdit.desc}</#if>">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-upload">
                ...
                <button type="button" style="margin-left: 110px;" class="layui-btn" id="testListAction">开始上传
                </button>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                ...
                <button class="layui-btn layui-btn-primary" id="closeBtn" type="button" >关闭</button>
            </div>
        </div>
        </form>
</div>
