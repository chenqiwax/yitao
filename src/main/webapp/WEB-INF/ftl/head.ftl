...
<header>
    <div class="header-all">
        <nav>
            <ul class="area">
                    <img class="img1" style="width: 30px;" src="${contextPath}/img/l.png">

                <a class="a1" target="_self" href="index.do" style="font-size: 15px;color: #4f2edb;">易淘首页</a>
            </ul>
            <ul class="navList">
                <li class="navList-top">欢迎光临易淘,请
                    <a class="login" href="login.html" target="_blank">登录</a>
                </li>
                <li class="navList-top">
                    <a href="regist.html" target="_blank">注册</a>
                </li>
                <li class="navList-top shopCar">
                    <a href="cart.html" target="_blank">购物车</a><span class="login">0</span></li>
                <li class="navList-top">
                ...
                <li class="hov">
                    ...
                    <div class="dangList1">
                        ...
                        <p>
                            <a href="/showBooks.do" target="_blank">我的足迹</a>
                        </p>
                    </div>
